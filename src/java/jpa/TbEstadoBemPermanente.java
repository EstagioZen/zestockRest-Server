...
public class TbEstadoBemPermanente implements Serializable {
    ...
    private Integer idEstadoBemPermanente;
    @Size(max = 64)
    ...
    public TbEstadoBemPermanente(Integer idEstadoBemPermanente) {
        this.idEstadoBemPermanente = idEstadoBemPermanente;
    }

    public Integer getIdEstadoBemPermanente() {
        return idEstadoBemPermanente;
    }

    public void setIdEstadoBemPermanente(Integer idEstadoBemPermanente) {
        this.idEstadoBemPermanente = idEstadoBemPermanente;
    }
